-- ========================================
-- MASTER MIGRATION - Run this in Neon SQL Editor
-- ========================================
-- This combines all 3 migrations into one script
...
CREATE INDEX IF NOT EXISTS "userStats_xp_idx" ON "userStats"(CAST("xp" AS INTEGER));
...
-- Notes constraints
ALTER TABLE notes 
  DROP CONSTRAINT IF EXISTS "fk_notes_userId",
  ADD CONSTRAINT "fk_notes_userId" 
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- Alarms constraints
ALTER TABLE alarms 
  DROP CONSTRAINT IF EXISTS "fk_alarms_userId",
  ADD CONSTRAINT "fk_alarms_userId" 
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- UserStats constraints
ALTER TABLE "userStats" 
  DROP CONSTRAINT IF EXISTS "fk_userStats_userId",
  ADD CONSTRAINT "fk_userStats_userId" 
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- FocusSessions constraints
ALTER TABLE "focusSessions" 
  DROP CONSTRAINT IF EXISTS "fk_focusSessions_userId",
  ADD CONSTRAINT "fk_focusSessions_userId" 
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- PushSubscriptions constraints
ALTER TABLE "pushSubscriptions" 
  DROP CONSTRAINT IF EXISTS "fk_pushSubscriptions_userId",
  ADD CONSTRAINT "fk_pushSubscriptions_userId" 
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- UserSessions constraints
ALTER TABLE "userSessions"
  DROP CONSTRAINT IF EXISTS "fk_userSessions_userId",
  ADD CONSTRAINT "fk_userSessions_userId"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE;

-- ActivityLog constraints
ALTER TABLE "activityLog"
  DROP CONSTRAINT IF EXISTS "fk_activityLog_userId",
